...
export function ProjectStatusesFilterBar({ 
  searchQuery, 
  onSearchChange, 
  statusFilter, 
  onStatusChange, 
  ...
  const STAGE_OPTIONS = [
    { value: 'all', label: 'All Stage Types' },
    { value: 'in_flight', label: 'In-Flight / Active' },
    { value: 'final', label: 'Final / Terminal' }
  ];
    ...
    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-2.5 mb-2.5">
      <div className="flex flex-wrap items-center gap-2 w-full lg:w-auto">
        <div className="w-full sm:w-[240px]">
          <SearchField 
            placeholder="Search code, status name, description..."
            value={searchQuery}
